              ...
              <Table>
                ...
                <TableBody>
                  {holdings.map((holding) => {
                    const gainLoss = holding.currentValueGBP - holding.amountInvestedGBP;
                    ...
                    return (
                      <TableRow key={Number(holding.id)} className="hover:bg-muted/20 transition-colors">
                        ...
                        <TableCell className="text-right font-semibold">£{holding.currentValueGBP.toLocaleString('en-GB', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</TableCell>
