...
export default function PortfolioOverview() {
  ...
  const { metrics, assetCards } = useMemo(() => {
    ...
    holdings.forEach((holding) => {
      ...
      totalValue += holding.currentValueGBP;
      ...
      if (existing) {
        ...
        existing.currentValue += holding.currentValueGBP;
      } else {
        assetMap.set(symbol, {
          symbol,
          amount: holding.amount,
          invested: holding.amountInvestedGBP,
          currentValue: holding.currentValueGBP,
          gainLoss: 0,
          gainLossPercent: 0,
        });
      }
  ...
  const isInitialLoading = holdingsLoading || rewardsLoading;
